...
public:
    ...
    GRect unite(const GRect &r) const;  // ### Qt 5: make QT4_SUPPORT
    GRect united(const GRect &other) const;
    GRect intersect(const GRect &r) const;  // ### Qt 5: make QT4_SUPPORT
...
inline GRect GRect::intersect(const GRect &r) const
{
    return *this & r;
}
...
inline GRect GRect::unite(const GRect &r) const
{
    return *this | r;
}
...
public:
    ...
    GRectF unite(const GRectF &r) const;  // ### Qt 5: make QT4_SUPPORT
    GRectF united(const GRectF &other) const;
    GRectF intersect(const GRectF &r) const;  // ### Qt 5: make QT4_SUPPORT
...
inline GRectF GRectF::intersect(const GRectF &r) const
{
    return *this & r;
}
...
inline GRectF GRectF::unite(const GRectF &r) const
{
    return *this | r;
}
